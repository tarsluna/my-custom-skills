# Règles de structuration des campagnes Meta — the platform
...
Justification : la consolidation budgétaire est une règle Meta 2026 (post-update Andromeda). Fragmenter en plusieurs campagnes sur petit budget tue l'algorithme avant qu'il sorte de la learning phase (50 events / 7 jours requis).
...
Exemples :
- `TopCo - Méthode 5DC - Leads - 2026-04`
- `BizClient - Audit Stratégie - Conversions - 2026-04`
...
- Ex : `TopCo-5DC / FaceCam / Douleur / V01`
