...
Structure markdown source que `build_proposal.py` consomme pour générer le .docx final.
...
Exemple :
> L'objectif de cette première phase est de valider l'appétence du marché francophone pour la Méthode 5DC™ sur un budget de test de 50€/jour. On lance une campagne Meta Lead Form ciblant les closers en activité bloqués entre 1 et 5K€/mois. On cherche à atteindre un CPL inférieur à 8€ et à générer 30 leads qualifiés sur les 14 premiers jours. Si ces seuils sont validés, on passe en phase de scaling immédiatement.
